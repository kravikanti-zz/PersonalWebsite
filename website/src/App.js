...
class App extends Component {
  ...
  scrollToSkills = () => {
    scrollToElement(".outer-skills-container", {duration: 750});
  };
      ...
      <div className="website-container">
        ...
        <nav id="dot-nav">
          <ul>
            <li className="dot-container">
              <a href="#intro-section" data-number="0" onClick={() => this.scrollToIntro()}>
                <span className="dot"></span>
                <span className="dot-label">Intro</span>
              </a>
            </li>
            <li className="dot-container">
              <a href="#about-section" data-number="0" onClick={() => this.scrollToAbout()}>
                <span className="dot"></span>
                <span className="dot-label">About</span>
              </a>
            </li>
            <li className="dot-container">
              <a href="#skills-section" data-number="1" onClick={() => this.scrollToSkills()}>
                <span className="dot"></span>
                <span className="dot-label">Skills</span>
              </a>
            </li>
            <li className="dot-container">
              <a href="#experience-section" data-number="2" onClick={() => this.scrollToExperience()}>
                <span className="dot"></span>
        ...
        <div className="home-container">
          ...
          <div className="scroll-wrapper">
            <img id="arrow" src={downarrow} onClick={() => this.scrollToAbout()}/>
          ...
          <div className="about-content">
            <div className="about-overlay">
              <h3 className="about-desc">
                I am a full-stack software engineer passionate about design and innovation while creating a robust product.
              </h3>
              <p className="about-text">
                Im a second year student at the University of Virginia in Charlottesville majoring in Computer Science and minoring in Global Studies. Currently, I am spending the summer in Charlottesville learning full-stack software development through Launch.
              </p>
              <p className="about-text">
                Im a second year student at the University of Virginia in Charlottesville majoring in Computer Science and minoring in Global Studies. Currently, I am spending the summer in Charlottesville learning full-stack software development through Launch.
              </p>
            ...
            <div className="skills-content">
              ...
              <ul className="skills-list">
                <li className="dev-skill">
                  ...
                  <span className="dev-skill" id="js">JavaScript</span>
                </li>
                <li className="dev-skill">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path fill="#ffffff" d="M112.771 30.334l-44.097-25.605c-2.781-1.584-6.402-1.584-9.205 0l-44.568 25.605c-2.87 1.651-4.901 4.754-4.901 8.073v51.142c0 3.319 2.084 6.423 4.954 8.083l11.775 6.688c5.628 2.772 7.617 2.772 10.178 2.772 8.333 0 13.093-5.039 13.093-13.828v-50.49c0-.713-.371-1.774-1.071-1.774h-5.623c-.712 0-2.306 1.061-2.306 1.773v50.49c0 3.896-3.524 7.773-10.11 4.48l-12.167-7.013c-.424-.23-.723-.693-.723-1.181v-51.142c0-.482.555-.966.982-1.213l44.424-25.561c.415-.235 1.025-.235 1.439 0l43.882 25.555c.42.253.272.722.272 1.219v51.142c0 .488.183.963-.232 1.198l-44.086 25.576c-.378.227-.847.227-1.261 0l-11.307-6.749c-.341-.198-.746-.269-1.073-.086-3.146 1.783-3.726 2.02-6.677 3.043-.726.253-1.797.692.41 1.929l14.798 8.754c1.417.82 3.027 1.246 4.647 1.246 1.642 0 3.25-.426 4.667-1.246l43.885-25.582c2.87-1.672 4.23-4.764 4.23-8.083v-51.142c0-3.319-1.36-6.414-4.229-8.073zM77.91 81.445c-11.726 0-14.309-3.235-15.17-9.066-.1-.628-.633-1.379-1.272-1.379h-5.731c-.709 0-1.279.86-1.279 1.566 0 7.466 4.059 16.512 23.453 16.512 14.039 0 22.088-5.455 22.088-15.109 0-9.572-6.467-12.084-20.082-13.886-13.762-1.819-15.16-2.738-15.16-5.962 0-2.658 1.184-6.203 11.374-6.203 9.105 0 12.461 1.954 13.842 8.091.118.577.645.991 1.24.991h5.754c.354 0 .692-.143.94-.396.24-.272.367-.613.335-.979-.891-10.568-7.912-15.493-22.112-15.493-12.631 0-20.166 5.334-20.166 14.275 0 9.698 7.497 12.378 19.622 13.577 14.505 1.422 15.633 3.542 15.633 6.395 0 4.955-3.978 7.066-13.309 7.066z"/>
                  </svg>
                  <span>Node.js</span>
                </li>
                <li className="dev-skill">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path fill="#ffffff" d="M9.032 2l10.005 112.093 44.896 12.401 45.02-12.387 10.015-112.107h-109.936zm89.126 26.539l-.627 7.172-.276 3.289h-52.665000000000006l1.257 14h50.156000000000006l-.336 3.471-3.233 36.119-.238 2.27-28.196 7.749v.002l-.034.018-28.177-7.423-1.913-21.206h13.815000000000001l.979 10.919 15.287 4.081h.043v-.546l15.355-3.875 1.604-17.579h-47.698l-3.383-38.117-.329-3.883h68.939l-.33 3.539z"/>
                  </svg>
                  <span>HTML 5</span>
                </li>
                <li className="dev-skill">
                          ...
                          <div id="timeline">
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      ...
                                      <h3 className="company"><a href="http://www.ccis.northeastern.edu/program/information-science-bs/" target="_blank">College of Arts & Sciences</a></h3>
                                      <p className="job-desc">Bachelor of Arts in Computer Science with a minor in Global Studies. <strong>Graduating in May 2020.</strong></p>
                                  </div>
                                  <div className="timeline-img">
                                      <div className="sprite university"></div>
                                  </div> <span className="date">2016 - Present</span> </div>
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      <h2 className="position">EDIT</h2>
                                      <h3 className="company"><a href="http://www.ccis.northeastern.edu/" target="_blank">EDIT</a></h3>
                                      <p className="job-desc">EDIT</p>
                                  </div>
                                  <div className="timeline-img">
                                      <div className="sprite research"></div>
                                  </div> <span className="date">EDIT</span> </div>
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      <h2 className="position">EDIT</h2>
                                      <h3 className="company"><a href="http://us.mullenlowe.com/" target="_blank">MullenLowe U.S.</a></h3>
                                      <p className="job-desc">EDIT</p>
                                  </div>
                                  <div className="timeline-img">
                              ...
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      <h2 className="position">EDIT</h2>
                                      <h3 className="company"><a href="http://nuwit.ccs.neu.edu" target="_blank">EDIT</a></h3>
                                      <p className="job-desc">EDIT</p>
                                  </div>
                                  <div className="timeline-img">
                                      <div className="sprite university"></div>
                              ...
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      <h2 className="position">EDIT</h2>
                                      <h3 className="company"><a href="https://starry.com/" target="_blank">Starry</a></h3>
                                      <p className="job-desc">EDIT</p>
                                  </div>
                                  <div className="timeline-img">
                                      <div className="sprite industry"></div>
                              ...
                              <div className="timeline-block">
                                  <div className="timeline-content">
                                      <h2 className="position">EDIT</h2>
                                      <h3 className="company"><a href="http://www.northeastern.edu/scout/" target="_blank">EDIT</a></h3>
                                      <p
                                          className="job-desc">EDIT</p>
                                  </div>
                                  <div className="timeline-img">
                                      <div className="sprite university"></div>
                                  </div> <span className="date">EDIT</span> </div>
                          </div> <i className="down-arrow"></i> </div>
                  </div>
              </div>
          </div>
          <a className="block-btn" href="http://brittanychiang.com/resume.pdf" target="_blank"> <span className="text">View my full resume</span> <img className="icon" src="./images/download.svg"/> </a>
        </div>
      </div>
    );
  }
