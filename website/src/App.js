    ...
    return (
      <div className="website-container">
        ...
        <div className="about-container">
          <div className="heading">Hey, Im Kavya.</div>
          <div className="about-content">
            <div className="about-overlay">
              ...
              <p className="about-text">
                Im a second year student at the University of Virginia in
        ...
        <div className="outer-skills-container">
          <div className="inner-skills-container">
            ...
            <div className="skills-content">
              ...
              <ul className="skills-list">
                <li className="dev-skill">
                  ...
                  <span className="dev-skill" id="js">
                    JavaScript
                  </span>
                </li>
                <li className="dev-skill">
            ...
            <div className="skills-content">
              <div className="skills-title">
                {<img className="dev-icon" src={devicon} />}Tools
              </div>
              <ul className="skills-list">
                <li className="dev-skill">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
        ...
        <div className="exp-container">
                ...
                <div className="experience-wrapper">
                  <div id="timeline">
                    <div className="timeline-block">
                      <div className="timeline-content">
                        ...
                        <h3 className="company">
                          <a
                            href="http://www.ccis.northeastern.edu/program/information-science-bs/"
                            target="_blank"
                          >
                    ...
                    <div className="timeline-block">
                      ...
                      <div className="timeline-img">
                        <div className="sprite research" />
                      </div>{" "}
                      <span className="date">EDIT</span>{" "}
                    </div>
                    <div className="timeline-block">
                      <div className="timeline-content">
                        <h2 className="position">EDIT</h2>
                        <h3 className="company">
                          <a href="http://us.mullenlowe.com/" target="_blank">
                            MullenLowe U.S.
                          </a>
                        </h3>
                        <p className="job-desc">EDIT</p>
                    ...
                    <div className="timeline-block">
                      <div className="timeline-content">
                        <h2 className="position">EDIT</h2>
                        <h3 className="company">
                          <a href="https://starry.com/" target="_blank">
                            Starry
                          </a>
                        </h3>
                        <p className="job-desc">EDIT</p>
          ...
          >
            ...
            <img className="icon" src="./images/download.svg" />{" "}
          </a>
        </div>
      </div>
    );
